  ...
  return (
    <section className="section department">
      <div className="container">
        ...
        <div className="dept-hero" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '2rem' }}>
          <img src="/ece-hd.jpg" alt="Electronics and Communication" style={{
            maxWidth: '100%',
            height: 'auto',
            borderRadius: '12px',
