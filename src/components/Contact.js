          ...
          <div className="contact-buttons-container">
            <div className="left-buttons">
              ...
              <div className="contact-card">
                <div className="status-badge">{isOpen ? 'Open Now' : 'Closed'}</div>
                ...
                <div style={{ color: '#757575', fontSize: '1.18rem', marginBottom: '0.5rem', lineHeight: '2rem' }}>
                  08256-236600,<br />9845893731, 9880724085
                </div>
              </div>

              {/* Email Card */}
              <div className="contact-card">
                <div className="status-badge">Available 24/7</div>
                <div style={{ marginBottom: '2rem', marginTop: '0.5rem' }}>
                  <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="35" cy="35" r="28" fill="#ffb300" />
            ...
            <div className="right-button">
              {/* Office Card */}
              <div className="contact-card">
                <div className="status-badge">Visit Us</div>
                <div style={{ marginBottom: '2rem', marginTop: '0.5rem' }}>
                  <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="35" cy="35" r="28" fill="#ffb300" />
                ...
                <div style={{ color: '#757575', fontSize: '1.18rem', marginBottom: '0.5rem', lineHeight: '2rem' }}>
                  The Principal,<br />SDM Polytechnic<br />Ujire
                </div>
              </div>
            </div>
          </div>
